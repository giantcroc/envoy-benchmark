...
export ENVOY_CONFIG=./envoy-http-tls-zstd-cert-compression.yaml
...
export ENVOY_BIN=/home/sdp/cert_compression/envoy-static-gzip
...
export BASE_DIR=$RESULT_BASE_DIR/zstd
